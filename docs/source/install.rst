...
.. code-block::
  ...
  mamba create -n kvikio-env -c rapidsai -c conda-forge python=3.14 cuda-version=13.3 kvikio
...
.. code-block::
  ...
  # Create new environment (CUDA 13)
  mamba create -n kvikio-env -c rapidsai-nightly -c conda-forge python=3.14 cuda-version=13.3 kvikio
...
.. code-block::
  ...
  # CUDA 13
  mamba env create --name kvikio-dev --file conda/environments/all_cuda-133_arch-$(arch).yaml
